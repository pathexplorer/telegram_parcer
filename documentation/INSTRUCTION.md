...
> **Formal specification (real):** see [TRD.md](TRD.md) — real TRD (source of truth, to be filled).
> **Retrospective spec (AI reverse):** see [TRD_reverse.md](TRD_reverse.md) for the formal requirements (FR/NFR), data model, failure modes and traceability matrix generated by AI reverse-engineering.
...
The full variable registry is the single source in [`config-manifest.md`](config-manifest.md) (real) / [`config-manifest_reverse.md`](config-manifest_reverse.md) (AI reverse).
