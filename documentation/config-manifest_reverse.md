> **⚠️ config-manifest_reverse — AI reverse-engineering placeholder**
>
> This file is the **future result of an AI analysis** that scans the codebase for all env vars, secrets and runtime config
> (single source of truth). Do not edit as primary source — the real manifest is [config-manifest.md](config-manifest.md).
> Expected generation: `AI -> codebase -> config-manifest_reverse.md`. Currently contains the last generated version.
